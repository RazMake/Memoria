...
**Entry:** `Open default file(s)`  
**Available:** Right-click context menu on folders **with configured** default file(s)

This is an Explorer context-menu action, not a Command Palette command.

It opens one or more pre-configured files for a folder, side by side in the editor. This provides quick access to the files you use most in each folder.

1. Right-click a folder in the Explorer that has a default file configured
