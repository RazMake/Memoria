...
1. **Read [CareerPaths.md](../../06-Autocomplete/Contacts/DataTypes/CareerPaths.md)** and extract from it the list of career names (including alternatives).
...
5. **Write the updated file [CareerLevels.md](../../06-Autocomplete/Contacts/DataTypes/CareerLevels.md)** using file-editing tools. Do not reformat unchanged entries.
